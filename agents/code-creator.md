...
2. Read the target file/module style (naming, imports, error handling, logging) and 1-2 sibling files with the same role. Match existing patterns — see `architecture-layering` for where new code belongs.
