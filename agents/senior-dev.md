...
Answering directly happens **in the current session** and reuses its context. Use `senior-dev` when you want an **independent** read: sanity-checking your conclusion, getting a second opinion before a risky change, or offloading exploration into isolated context.
