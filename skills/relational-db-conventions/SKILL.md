---
name: relational-db-conventions
description: "SQLAlchemy/ORM rules: scoped sessions, explicit column selection, eager loading to avoid N+1, parameterized queries, migrations alongside model changes. Apply when writing or reviewing SQLAlchemy/ORM/migration code, or a prompt mentions models, queries, or migrations — triggers on topic, not file path."
---
