---
name: dependency-config-management
description: "Rules for adding dependencies and handling runtime configuration: pin versions, justify a new dependency only after existing options are exhausted, load config from env/files only, fail fast on invalid config at startup. Apply when adding/updating a dependency or reading/writing configuration."
---
