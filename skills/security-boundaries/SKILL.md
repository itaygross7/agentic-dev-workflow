...
description: "Boundary-hardening rules for HTTP routes and worker/queue handlers: validate untrusted input at the boundary, authenticate before authorizing, return generic errors externally, guard path traversal, validate queue messages. Apply at HTTP and worker entry points."
---
