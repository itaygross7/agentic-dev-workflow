---
name: web-crawling-conventions
description: Crawler/scraper code rules. Apply when writing or reviewing crawler/scraper/spider code — triggers on topic, not file path. For the legal/ethical check and tool-selection process before building one see web-crawling-workflow.
---
