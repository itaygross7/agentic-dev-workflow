...
description: "Passive Python coding rules to apply whenever writing or editing any Python file: explicit type hints, specific exceptions with `raise...from`, no mutable default args, scoped try/except, structured logging over print. Always-on background convention, not a multi-step process — for the step-by-step change workflow see python-implementation-workflow."
---
